...
(function(window, undefined) {
  ...
  DocsCoApi.prototype.askLock = function(arrayBlockId, callback) {
    ...
    if (!isLock) {
      ...
      //this._onServerMessage('{"type":"getLock","locks":[{"time":1533288203390,"user":"uid-12","block":{"type":1,"slideId":"1243","objId":"1249","guid":"1249"},"sessionId":"ac4a1a45-82bc-4889-bc5a-d146ec181ae2"}]}');
    } else {
  ...
  DocsCoApi.prototype.askSaveChanges = function(callback) {
    ...
    this._onServerMessage('{"type":"saveLock","saveLock":false}');
  };
  ...
  DocsCoApi.prototype.saveChanges = function(arrayChanges, currentIndex, deleteIndex, excelAdditionalInfo) {
    ...
    this._onServerMessage('{"type":"unSaveLock","index":-1,"time":1533288218313}');
  };
  ...
  DocsCoApi.prototype.getMessages = function() {
    ...
    this._onServerMessage('{"type":"message"}');
  };
  ...
  DocsCoApi.prototype.setDocId = function(docid) {
    ...
    this.sockjs_url = 'http://192.168.95.128/2018-05-22-13-26/doc/' + docid + '/c';
  };
  ...
  DocsCoApi.prototype.auth = function(isViewer, opt_openCmd, opt_isIdle) {
    ...
    if (window['EDITOR_ONLINE']) this._send({
      'type': 'auth',
      'docid': this._docid,
      ...
      //this._onServerMessage('{"type":"documentOpen","data":{"type":"open","status":"ok","data":{"Editor.bin":"../../../../../ppty/Editor.bin","media/image1.png":"../../../../../media/image1.png","media/image10.png":"../../../../../media/image10.png","media/image11.png":"../../../../media/image11.png","media/image12.png":"../../../../../media/image12.png","media/image2.png":"../../../../media/image2.png","media/image3.png":"../../../../media/image3.png","media/image4.png":"../../../../media/image4.png","media/image5.png":"media/image5.png","media/image6.png":"media/image6.png/image6.png","media/image7.png":"../../../../media/image7.png","media/image8.png":"../../../../media/image8.png","media/image9.png":"../../../../media/image9.png"}}}');
      this._onServerMessage(JSON.stringify({
        "type":"documentOpen",
        "data":{
          "type":"open",
          "status":"ok",
      ...
      //this._onServerMessage('{"type":"documentOpen","data":{"type":"open","status":"ok","data":{"Editor.bin":"/ppty/Editor.bin"}}}');
    }
  };
	...
	DocsCoApi.prototype._initSocksJs = function () {
		var t = this;
		var sockjs;
		if (window['EDITOR_ONLINE']) if (window['IS_NATIVE_EDITOR']) {
      ...
      t._onServerOpen();
      t._onServerMessage('{"type":"license","license":{"type":3,"light":false,"mode":0,"rights":1,"buildVersion":"5.1.4","buildNumber":22,"branding":false}}');
    }
